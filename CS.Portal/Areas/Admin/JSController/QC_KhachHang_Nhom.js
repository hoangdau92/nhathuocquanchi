...
function searchForm() {
    ...
    var strRoleID = jQuery("#ddlGroup").val();
...
function AJAXGetUsersGroup(name, strRoleID) {
    try {
        ...
        jQuery.ajax({
            url: SiteUrlAdmin + "/QC_KhachHang_Nhom/GetUsersGroup",
            ...
            success: function (response) {
                ...
                jQuery.each(listUserNotInGroup, function (i, item) {
                    options += "<div class='checkbox userGroup'><label title ='" + item.tendaydu + "' class='CSFtooltip'><input id='chkUser_" + item.id + "' value='" + item.id + "' name='chkUsersNotInGroup' type='checkbox'>" + item.tendaydu + "</label></div>";
                });
                ...
                jQuery.each(listUserInGroup, function (i, item) {
                    options += "<div class='checkbox userGroup'><label title ='" + item.tendaydu + "' class='CSFtooltip'><input id='chkUser_" + item.id + "' value='" + item.id + "' name='chkUsersInGroup' type='checkbox'>" + item.tendaydu + "</label></div>";
                });
...
function setUserInGroup() {
    try {
        ...
        jQuery.ajax({
            url: SiteUrlAdmin + "/QC_KhachHang_Nhom/SetUsersInGroup",
            contentType: 'application/json',
            dataType: 'json',
...
function setUserOutGroup() {
    try {
        ...
        var pJson = { 'arrChecked': checkedValues, 'RoleID': RoleID };
        jQuery.ajax({
            url: SiteUrlAdmin + "/QC_KhachHang_Nhom/SetUsersOutGroup",
            contentType: 'application/json',
            dataType: 'json',
            data: JSON.stringify(pJson),
            type: "POST",
