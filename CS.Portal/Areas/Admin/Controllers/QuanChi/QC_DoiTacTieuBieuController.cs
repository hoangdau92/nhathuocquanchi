...
{
    public class QC_DoiTacTieuBieuController : BaseController
    {
        quanchiEntities ctx = new quanchiEntities();
        //
        // GET: /Admin/QC_DoiTacTieuBieu/
        ...
        public ActionResult Index(string keyword, int? page)
        {
            try
            {
                ...
                var data = ctx.QC_DoiTacTieuBieu.Where(x => x.ten.Contains(keyword)).ToList();
        ...
        public ActionResult Edit(int id)
        {
            try
            {
                var obj = ctx.QC_DoiTacTieuBieu.Find(id);
                if (obj != null)
                {
                    return View(obj);
                }
        ...
        public JsonResult Delete(int id)
        {
            try
            {
                ...
                if (obj != null)
                {
                    ctx.QC_DoiTacTieuBieu.Remove(obj);
                    ctx.SaveChanges();
